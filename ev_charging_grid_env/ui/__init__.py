...
<body>
  <div class=\"card\">
    ...
    <div class=\"metric\"><strong>Task ID:</strong> {snapshot.get('task_id')}</div>
    <div class=\"metric\"><strong>Step:</strong> {snapshot.get('step')}</div>
    <div class=\"metric\"><strong>Queue Length:</strong> {snapshot.get('queue_length')}</div>
    <div class=\"metric\"><strong>Vehicles Served:</strong> {snapshot.get('vehicles_served')}</div>
  </div>
</body>
</html>"""
